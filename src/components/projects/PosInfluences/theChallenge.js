const TheChallenge = () => {
    return (
        ...
        <div className="topics">
            ...
            <section className="subtopics">PROBLEM</section>
                <div className="topicSections">
                    <h4 className="sectionTitle">'선한영향력가게' 보완사항</h4>
                    <p>사용하기에 여러가지 불편한 사항이 있었습니다.</p>
                    <ul>
                        <li>가독성이 떨어짐
                            <ul>
                                <li>분류: </li>
            ...
            <section className="subtopics">SCOPE</section>
                <p>편의성 향상을 통해 서비스 제공자와 사용자의 만족도를 높이고, 결식아동의 사용 빈도수 향상</p>
                <p>2019년 12월부터 2020년 1월까지 제작. 앱 프로토타입 제작</p>
            <section className="subtopics">ROLE</section>
                <p>혼자 제작 Figma</p>
            <section className="subtopics">COPYRIGHT</section>
                <p>선한영향력가게 사단법인</p>
        </div>
        </>
     );
